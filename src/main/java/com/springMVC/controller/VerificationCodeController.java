...
import com.springMVC.Util.ResourceUtil;
...
public class VerificationCodeController extends HttpServlet {
     ...
     * 描述：根据给定的数字生成不同的颜色
     *
     * @param bc，颜色模式是指使用三种基色：红、绿、蓝，通过三种颜色的调整得出其它各种颜色，这三种基色的值范围为0～255
     * @param fc，颜色模式是指使用三种基色：红、绿、蓝，通过三种颜色的调整得出其它各种颜色，这三种基色的值范围为0～255
     * @return 描述：返回颜色
     */
